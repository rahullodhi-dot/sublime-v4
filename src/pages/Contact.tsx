          ...
          <div className="lg:col-span-6 space-y-4   ">
            ...
            <div className="space-y-1 gap-2  flex flex-col bg-[#F1E4B0] border p-3 rounded-lg">
              <div className='flex justify-start gap-2 mb-2 items-center'>
                <div className="h-6 flex justify-center items-center  w-6 bg-[#9a7523] rounded-full">   <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 28 28" fill="none">
